...
public class FLDTestData {
	...
	private static List<NumericalFeatureVector> createTestData(double x0, double y0, double x1, double y1,
			double noiseSize, int n, int dim, Random random, String classAttributeName, int classLabel) {
	...
	private static List<NumericalFeatureVector> createTestData(double min[], double max[], int n, Random random,
			String classAttributeName, int classLabel) {
	...
	private static NumericalFeatureVector create(double values[], String classAttributeName, int classLabel) {
		NumericalFeatureVector numericalFeatureVector = NumericalFeatureVectors.createNumericalFeatureVector(values);

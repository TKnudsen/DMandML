 ...
 * publisher = {Morgan Kaufmann, Los Altos, CA}, title = {Fast Algorithms for
 * Mining Association Rules in Large Databases}, year = {1994} }
 * 
 * 
 * inproceedings{Liu1998, author = {Bing Liu and Wynne Hsu and Yiming Ma},
 * booktitle = {Fourth International Conference on Knowledge Discovery and Data
 * Mining}, pages = {80-86}, publisher = {AAAI Press}, title = {Integrating

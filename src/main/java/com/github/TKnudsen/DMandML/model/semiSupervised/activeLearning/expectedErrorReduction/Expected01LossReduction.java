 ...
 * reduction when labeling a candidate with its respective label
 * distribution. This is an implementation of the method proposed in Section
 * 4.1 (Equation (4.1)) in "Active Learning", by Burr Settles (2012).
 * </p>
 *

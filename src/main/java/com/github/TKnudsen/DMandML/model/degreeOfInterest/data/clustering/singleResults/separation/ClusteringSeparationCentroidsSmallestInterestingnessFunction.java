 ...
 * <br>
 * 
 * Assigns an interestingness score to each instance based on its margin between
 * the winning and the second winning centroid.
 * </p>
 * 
 * @version 1.01
 */
public class ClusteringSeparationCentroidsSmallestInterestingnessFunction<FV>
		extends ClusteringBasedDegreeOfInterestingnessFunction<FV> {

	private final IDistanceMeasure<FV> distanceMeasure;

	public ClusteringSeparationCentroidsSmallestInterestingnessFunction(
	...
	protected Double calculateInterestingnessScore(FV fv) {
		...
		// smallest margin shall win
		return -margin;
	}

	@Override
	public String getName() {
		return "Cluster Separation Centroid Smallest Margin [" + getClusteringResult().getName() + "]";
	}

	@Override
	public String getDescription() {
		return "Assigns interestingness scores depending on small distances of centroid margins.";
	}
}

 ...
 * @version 1.01
 */
public class OutlierBasedInterestingnessFunction<FV extends AbstractFeatureVector<?, ?>> extends DegreeOfInterestFunction<FV> implements IDataBasedInterestingnessFunction<FV> {

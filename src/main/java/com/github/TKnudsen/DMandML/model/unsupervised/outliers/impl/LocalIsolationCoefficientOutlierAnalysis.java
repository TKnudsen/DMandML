 ...
 * average distance to its k nearest neighbors. The algorithm originally used
 * a normalized Manhattan distance on numerical attributes, and Hamming
 * distance on categorial attributes. B. Yu, and M. Song, and L. Wang Local
 * Isolation Coefficient-Based Outlier Mining Algorithm Int. Conf. on
 * Information Technology and Computer Science (ITCS) 2009
 * </p>
 *
 * @version 1.01
 * @since 2018
